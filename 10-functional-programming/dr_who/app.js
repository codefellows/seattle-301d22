// (function(module) {
  ...
  // `.reduce()` => returns a new value; defaulting to initial values, but can also be a new array of values
  ...
  // returns => 234 (because we changed the default initial value to `1`)

  // Pass an array as the accumulator.
